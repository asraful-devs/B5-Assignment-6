                ...
                <div className='mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8'>
                    <div className='mx-auto max-w-md'>
                        <strong className='block text-center text-xl font-bold text-gray-900 sm:text-3xl dark:text-white'>
                            Want us to email you with the latest blockbuster
                            news?
                        </strong>
                    ...
                    <div className='mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32'>
                        <div className='mx-auto max-w-sm lg:max-w-none'>
                            ...
                            <p className='mt-4 text-center text-gray-500 lg:text-left lg:text-lg dark:text-gray-400'>
                                ...
                                and strategists dedicated to turning bold ideas
                                into powerful digital experiences. Whether
                                you're building a brand, launching an app, or
                                crafting a marketing campaign, we bring clarity,
                                creativity, and code to every project.
                            </p>
                            ...
                            <div className='mt-6 flex justify-center gap-4 lg:justify-start'>
                                ...
                                <a
                                    className='text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75'
                                    href='https://instagram.com/asraful.devs'
                                    target='_blank'
                                    rel='noreferrer'
                                >
                                ...
                                <a
                                    className='text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75'
                                    href='https://twitter.com/asraful_devs'
                                    target='_blank'
                                    rel='noreferrer'
                                >
